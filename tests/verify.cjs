...
await page.goto(url); await page.waitForFunction(()=>!document.querySelector('#start-btn').disabled);
...
await page.reload();await page.waitForFunction(()=>!document.querySelector('#endless-btn').disabled);
...
await mp.goto(url);await mp.waitForFunction(()=>!document.querySelector('#endless-btn').disabled);
...
await bp.goto(url);await bp.waitForFunction(()=>!document.querySelector('#endless-btn').disabled);await bp.click('#endless-btn');
